...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`International Certificate Course`}</title>

        <meta
          name="description"
          content="Welcome to International Certificate Course - Your Gateway to World-Class Certification. Log in, subscribe, and step into global recognition."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjk1ODc3ODIxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to International Certificate Course - Your Gateway to World-Class Certification. Log in, subscribe, and step into global recognition.`}
            </Text>
            <Box
