...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'maintenance_scheduled.update': { roles: ['tenant-roles'], key: 'maintenance', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['organization-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['organization-owner', 'administrator', 'subscriber'];
